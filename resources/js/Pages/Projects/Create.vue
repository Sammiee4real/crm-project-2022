    ...
    <BreezeAuthenticatedLayout>
        <template #header>
            <h2 class="flex justify-between items-center font-semibold text-sm text-gray-800 leading-tight">
                <div class="text-xl">Create A Project</div> <span><Link :href="route('projects.index')" as="button" class="bg-indigo-800 p-2 rounded-xl text-white">All Projects</Link></span>
            </h2>
        </template>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                         ...
                         <div class="col-span-6 sm:col-span-3">
                            <BreezeLabel for="user_id" value="Select User" />
                             <select class="mt-1 block w-full" v-model="form.user_id" id="user_id">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <BreezeLabel for="client_id" value="Select Client" />
                             <select class="mt-1 block w-full" v-model="form.client_id" id="client_id">
