    ...
    <BreezeAuthenticatedLayout>
        <template #header>
            <h2 class="flex justify-between items-center font-semibold text-sm text-gray-800 leading-tight">
                <div class="text-xl">Create A User</div> <span><Link :href="route('users.index')" as="button" class="bg-indigo-800 p-2 rounded-xl text-white">All Users</Link></span>
            </h2>
        </template>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                          ...
                          <div class="col-span-6 sm:col-span-3">
                            ...
                            <!-- <BreezeDropdown  class="mt-1 block w-full" v-model="form.role" required autofocus /> -->
